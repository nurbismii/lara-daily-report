...
<div class="container-xxl flex-grow-1 container-p-y">
  <form action="{{route('store.tambah-kegiatan.harian')}}" enctype="multipart/form-data" method="post">
    @csrf
    <div class="row">
      <div class="col-xl-12">
        @include('message')
      ...
      <div class="col-lg-12">
        <div class="card mb-3">
          ...
          <div class="card-body control-group after-add-more">
            <div class="row">
              <div class="col mb-2">
                <input type="hidden" name="absensi_id" class="form-control" value="{{ $data_absensi->id }}">
              </div>
            </div>
            <div class="row">
              <div class="col mb-2">
